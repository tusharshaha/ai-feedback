...
function generateFeedbackSoution(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        var _c;
        var type = _b.type, subject = _b.subject, feedback = _b.feedback;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, openai_config_1.default.chat.completions.create({
                            ...
                            messages: [
                                {
                                    role: "system",
                                    content: "You are a highly skilled software assistant specializing in analyzing bug reports and providing effective, concise solutions.",
                                },
                ...
                case 1:
                    completion = _d.sent();
                    return [2 /*return*/, (_c = completion.choices[0]) === null || _c === void 0 ? void 0 : _c.message.content];
                case 2:
                    error_1 = _d.sent();
                    console.error("Error generating article:", error_1);
                    throw error_1;
...
//# sourceMappingURL=generateFeedback.js.map